...
Debug.JustUpdateDeviceLine();
preferencesdialog.__c.runVoidMethod ("LogImpl","912189745",RemoteObject.concat(RemoteObject.createImmutable("Unknown type: "),_prefitem.getField(true,"ItemType" /*RemoteObject*/ )),0);
 break; }
}
;
 }
