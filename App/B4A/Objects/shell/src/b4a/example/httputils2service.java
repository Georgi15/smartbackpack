...
public static b4a.example.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"B4XCollections",Debug.moduleToString(b4a.example.b4xcollections.class),"B4XPages",Debug.moduleToString(b4a.example.b4xpages.class),"DateUtils",httputils2service.mostCurrent._dateutils,"hc",httputils2service._hc,"Main",Debug.moduleToString(b4a.example.main.class),"Service",httputils2service.mostCurrent._service,"Starter",Debug.moduleToString(b4a.example.starter.class),"taskCounter",httputils2service._taskcounter,"TaskIdToJob",httputils2service._taskidtojob,"TempFolder",httputils2service._tempfolder,"XUIViewsUtils",Debug.moduleToString(b4a.example.xuiviewsutils.class)};
}
}